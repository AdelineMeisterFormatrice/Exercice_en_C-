...
namespace ConsoleApplication2
{
    ...
    class Program
    {
        private static string SqlConnectionString = @"Server=.\SQLExpress;Database=Operation;Trusted_Connection=Yes";
        static void Main(string[] args)
        {
            ...
            while (shouldContinue)
            {
                ...
                if (operateur == TypeOperateur.Inconnu)
                {
                    ...
                    InsererOperationEnBDD(valeurGauche, valeurDroite, operateur);
        ...
        private static void InsererOperationEnBDD(double valeurGauche, double valeurDroite, TypeOperateur operateur)
        {
            ...
            var valeurGaucheParameter = new SqlParameter("@valeurGauche", valeurGauche);
            var valeurDroiteParameter = new SqlParameter("@valeurDroite", valeurDroite);
            var operateurParameter = new SqlParameter("@operateur", operateur);
