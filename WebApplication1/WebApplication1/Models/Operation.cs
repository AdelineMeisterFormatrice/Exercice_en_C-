...
namespace WebApplication1.Models
{
   ...
   public enum TypeOperateur
    ...
    public class Operation
    {
        ...
        public int idOperateur { get; private set; }
        /// <summary>
        ...
        public Operation(TypeOperateur operateur, double operandeDroite, double operandeGauche, int Id_Operateur)
        {
            this.Operateur = operateur;
            this.OperandeDroite = operandeDroite;
            this.OperandeGauche = operandeGauche;
            this.idOperateur = Id_Operateur;
        }
